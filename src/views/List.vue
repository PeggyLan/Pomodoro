<template>
  <div id="list" class="d-flex flex-column justify-content-center align-items-center">
      <b-form-input v-model="newtodo" placeholder="請輸入事項..." @keydown.enter="addTodo"></b-form-input>
      <b-btn variant="success" @click="addTodo" class="mt-2">新增</b-btn>
    <b-table-simple class="my-5">
      <b-thead>
        <b-tr>
          <b-th>事項</b-th>
          <b-th>動作</b-th>
